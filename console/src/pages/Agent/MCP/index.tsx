    ...
    <div style={{ padding: 24 }}>
      ...
      >
        <div>
          ...
          <p style={{ margin: 0, color: "var(--pb-text-caption)", fontSize: 14 }}>
            {t("mcp.description")}
          </p>
        </div>
      ...
      {loading ? (
        <div style={{ textAlign: "center", padding: 60 }}>
          <p style={{ color: "var(--pb-text-caption)" }}>{t("common.loading")}</p>
        </div>
      ) : clients.length === 0 ? (
      ...
      >
        <div style={{ marginBottom: 12 }}>
          <p style={{ margin: 0, fontSize: 13, color: "var(--pb-text-secondary)" }}>
            {t("mcp.formatSupport")}:
          </p>
          <ul
            style={{
