...
**MCP (Model Context Protocol)** allows ProwlrBot to connect to external MCP servers and use their tools. You can add MCP clients through the Console to extend ProwlrBot's capabilities.
...
ProwlrBot supports three JSON formats for importing MCP clients:
